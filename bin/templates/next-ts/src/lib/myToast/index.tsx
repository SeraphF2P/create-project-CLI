...
export const ToastContainer = HotToaster;
...
const helper = (type: ToastOpts["type"]) => {
  return (params: Omit<ToastOpts, "type">) => toast({ type, ...params });
};
toast.success = helper("success");
toast.error = helper("error");
toast.info = helper("info");
toast.warn = helper("warn");
